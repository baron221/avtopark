...
export default async function NewFinePage() {
  ...
  return (
    <div className="max-w-[520px] mx-auto w-full p-4 sm:p-7">
      <Link href="/accountant/fines" className="inline-flex items-center bg-page border border-border text-muted-2 rounded-lg px-3 py-1.5 text-[13px] font-bold hover:border-primary hover:text-primary hover:bg-primary-tint transition-colors">
        ← Жарималарга қайтиш
      </Link>
